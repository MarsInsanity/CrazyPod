...
cc -std=c99 -Wall -Wextra -Werror \
    ...
    -I"$repo_root/apps/crazypod" \
    -I"$repo_root/firmware/export" \
    "$repo_root/apps/crazypod/crazypod_mono.c" \
    "$repo_root/tests/crazypod_mono_host_test.c" \
    -o "$test_root/crazypod_mono_host_test"

"$test_root/crazypod_mono_host_test"
...
python3 "$repo_root/tests/test-crazypod-shrink-ipod-covers.py"
